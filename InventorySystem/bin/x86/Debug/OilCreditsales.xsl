			...
			<body link="#0c0000" vlink="#050000">
				<table border="1" bgcolor="#ffffff" cellspacing="0" cellpadding="0" id="CTRL1">
					<colgroup>
						...
						<col style="WIDTH: 1.2166in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.0333in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.1833in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.1833in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 0.9375in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.1666in"/>
						<col style="TEXT-ALIGN: right; WIDTH: 1.1916in"/>
					</colgroup>
					<tbody>
						<tr>
							<td>
							...
							<td>
								<div align="center">
									<strong>SalesDate</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>1LitreQty</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>2LitreQty</strong>
								</div>
							</td>
							<td>
								<div align="center">
									<strong>5LitreQty</strong>
								</div>
							</td>
							<td>
								<div align="center">
					...
					<tbody id="CTRL2">
						<xsl:for-each select="OilCreditsales">
							...
							<tr>
								...
								<td>
									<xsl:value-of select="fx:FormatFromXSL('SalesDate', 'Short Date', '', '', 7)"/>
								</td>
								<td>
									<xsl:value-of select="_x0031_LitreQty"/>
								</td>
								<td>
									<xsl:value-of select="_x0032_LitreQty"/>
								</td>
								<td>
									<xsl:value-of select="_x0035_LitreQty"/>
								</td>
								<td>
